...
<center>
		<h2>Students Portal</h2>
		    <marquee> Welcome to Student Portal.. </marquee>
...
<form action="/StudentManagementSystem/students/search" class="form-inline">
			...
			<!-- Add a button -->
			<a href="/StudentManagementSystem/student/begin-add"
					...
					<tr>
						...
						<td><c:out value="${tempStudent.country}" /></td>
                           <td>
							...
							<a
							href="/StudentManagementSystem/student/begin-update?studentId=${tempStudent.id}"
